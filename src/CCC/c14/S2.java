...
public class S2 {
    ...
    public static void main(String[] args) {
        ...
        String[] names1 = new String[personCount];
        for (int i = 0; i < personCount; i++) {
            names1[i] = s.nextString();
        }
        String[] names2 = new String[personCount];
        for (int i = 0; i < personCount; i++) {
            names2[i] = s.nextString();
        }

        HashMap<String, String> nameMap1 = new HashMap<>();
        HashMap<String, String> nameMap2 = new HashMap<>();
        for (int i = 0; i < personCount; i++) {
            String name1 = names1[i];
            String name2 = names2[i];
            nameMap1.put(name1, name2);
            nameMap2.put(name2, name1);
        }

        for (Map.Entry<String, String> entry : nameMap1.entrySet()) {
            if(entry.getValue().equals(entry.getKey()) || !nameMap2.get(entry.getKey()).equals(entry.getValue())){
