...
public class S3B {
    ...
    public static void main(String[] args) {
        ...
        int gateCount = s.nextInt();
        int planeCount = s.nextInt();

        DisjointSets dSet = new DisjointSets(gateCount + 1);
        for (int i = 0; i < planeCount; i++) {
            int maxGate = s.nextInt();
            int rep = dSet.find(maxGate);
            if (rep > 0) {
                dSet.union(rep, rep - 1);
            } else {
