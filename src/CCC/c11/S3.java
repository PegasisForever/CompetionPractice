...
public class S3 {
    ...
    static boolean step(int m, int x, int y) {
        if (m == 1) {
            return x == 1 && y == 0 || x == 2 && y == 0 || x == 3 && y == 0 || x == 2 && y == 1;
        } else {
            int scale = (int) Math.pow(5, m - 1);
            int smallX = x / scale;
            int smallY = y / scale;
            if (smallX == 1 && smallY == 0 || smallX == 2 && smallY == 0 || smallX == 3 && smallY == 0 || smallX == 2 && smallY == 1) {
                return true;
            } else if (smallX == 1 && smallY == 1 || smallX == 2 && smallY == 2 || smallX == 3 && smallY == 1) {
                return step(m - 1, x % scale, y % scale);
            } else {
                return false;
            }
        }
